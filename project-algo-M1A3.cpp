...
void generateSeribuDataDummy() {
    ...
    cout << "\n[DEV]: Memulai proses pabrikasi 100 data dummy ke dalam memori..." << endl;
    ...
    cout << "[DEV]: Duarr 100 lapangan pekerjaan telah dibuat!!!" << endl;
    cout << "[DEV]: Cek Menu 2 untuk melihat, lalu tekan Menu 5 untuk menyimpan ke CSV!\n" << endl;
}
...
int main() {
    ...
    while (lanjut) {
        ...
        cout << "7. [DEV] Generate 100 Data Dummy (WARNING!!! DATA YANG ADA AKAN DITIMPA)" << endl; 
        cout << "Pilih menu (1-7): ";
