...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(792, 364);
			...
			this->label3->Location = System::Drawing::Point(798, 394);
			...
			this->label4->Location = System::Drawing::Point(774, 278);
			...
			this->textBox3->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm::MyForm_KeyPress);
			// 
			// dataGridView1
			// 
			...
			this->label5->Location = System::Drawing::Point(746, 209);
			this->label5->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(580, 62);
			...
			this->textBox4->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm::MyForm_KeyPress);
			// 
			// textBox5
			// 
			...
			this->textBox5->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MyForm::MyForm_KeyPress);
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(749, 307);
			...
			this->label7->Location = System::Drawing::Point(783, 334);
			...
			this->button5->Location = System::Drawing::Point(1065, 303);
			this->button5->Margin = System::Windows::Forms::Padding(2);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(128, 49);
			this->button5->TabIndex = 17;
			this->button5->Text = L"perbarui";
			...
			this->button4->Location = System::Drawing::Point(987, 472);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Bell MT", 72, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(723, 54);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(628, 162);
...
private: System::Void MyForm_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
	System::Windows::Forms::TextBox^ currentTextBox = safe_cast<System::Windows::Forms::TextBox^>(sender);

	if (currentTextBox->Name == "textBox5" || currentTextBox->Name == "textBox2" || currentTextBox->Name == "textBox4") {
		if (!System::Char::IsLetterOrDigit(e->KeyChar) && !System::Char::IsControl(e->KeyChar) && e->KeyChar != ' ') {
			e->Handled = true;
		}
	}
	else {
		if (!System::Char::IsDigit(e->KeyChar) && !System::Char::IsControl(e->KeyChar)) {
			e->Handled = true;
		}
	}
}
